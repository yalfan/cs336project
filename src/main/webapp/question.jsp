	        	...
	        	while (questions.next()) {
	        		%>
		       		<div class="container post-container">
			            ...
			            <%
			            if (questions.getBoolean("Answered_Status")) {
			            	%><div class="valid-feedback" style="display: block;">Answered</div><%
			            }
			            else {
			            	%><div class="invalid-feedback" style="display: block;">Not Answered</div><%
			            }
			            %>
			            <form action="answer.jsp">
		            		<input type="hidden" name="questionID" value="<%= questions.getInt("Question_ID") %>"/>
       				    	<input type="submit" value="Answer(s)"/>
		            	</form>
			        </div>
	        		<%
	        	}
